...
//need to make sure the correct System.Data.dll is in the main Asset Folder
//from Unity\Editor\Data\MonoBleedingEdge\lib\mono\unity
using UnityEngine;
	using System;
    using System.Data;
...
namespace tycoon
	{
        ...
        public void calculateNetWorth(double money, List<Item> inventory)
        ...
        void storeEndDayData(double money, List<Item> inventory)
        {
        ...
        public double calculateGoodsValue(List<Item> GoodsList)
        {
            double goodsValue = 0;
